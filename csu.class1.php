<?php 
	...
	*/
	class CSU
	{
		...
		{
			$cookieJar = $this->cookieJar;
			$url = "http://csujwc.its.csu.edu.cn/jsxsd/kscj/cjcx_list";
		...
		private function CSU_INIT()
		{
			...
			$cookieJar = $this->cookieJar;
			$ch =curl_init();  
			curl_setopt($ch,CURLOPT_URL,"http://csujwc.its.csu.edu.cn/jsxsd/");   
			curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);  
			curl_setopt($ch,CURLOPT_HEADER,1);
			...
			$ch =curl_init();  
			curl_setopt($ch,CURLOPT_URL,"http://csujwc.its.csu.edu.cn/jsxsd/xk/LoginToXk");   
			curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);  
			curl_setopt($ch,CURLOPT_HEADER,1);
			curl_setopt($ch, CURLOPT_HTTPHEADER, $header);
			curl_setopt($ch, CURLOPT_POST, 1);
			...
			$ch =curl_init();  
			curl_setopt($ch,CURLOPT_URL,"http://csujwc.its.csu.edu.cn/jsxsd/framework/xsMain.jsp");   
			curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);  
			curl_setopt($ch,CURLOPT_HEADER,1);
